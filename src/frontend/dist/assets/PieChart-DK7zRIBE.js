import { n as commonjsGlobal, p as getDefaultExportFromCjs, r as reactExports, b as clsx, o, q as invariant } from "./index-D0P90mBY.js";
...
function Surface(props) {
  ...
  return /* @__PURE__ */ o.createElement("svg", _extends$t({}, filterProps(others, true, "svg"), {
    className: layerClass,
    width,
    height,
    style,
    viewBox: "".concat(svgView.x, " ").concat(svgView.y, " ").concat(svgView.width, " ").concat(svgView.height)
  }), /* @__PURE__ */ o.createElement("title", null, title), /* @__PURE__ */ o.createElement("desc", null, desc), children);
}
...
var Symbols = function Symbols2(_ref) {
  ...
  if (cx === +cx && cy === +cy && size === +size) {
    return /* @__PURE__ */ o.createElement("path", _extends$r({}, filteredProps, {
...
function _callSuper$g(t2, o2, e3) {
  return o2 = _getPrototypeOf$h(o2), _possibleConstructorReturn$h(t2, _isNativeReflectConstruct$h() ? Reflect.construct(o2, e3 || [], _getPrototypeOf$h(t2).constructor) : o2.apply(t2, e3));
}
  ...
  return _createClass$k(DefaultLegendContent2, [{
    ...
    value: (
      ...
      function renderIcon(data) {
        ...
        if (/* @__PURE__ */ o.isValidElement(data.legendIcon)) {
          var iconProps = _objectSpread$A({}, data);
          delete iconProps.legendIcon;
          return /* @__PURE__ */ o.cloneElement(data.legendIcon, iconProps);
        }
        return /* @__PURE__ */ o.createElement(Symbols, {
          fill: color2,
          cx: halfSize,
          cy: halfSize,
          size: SIZE,
    ...
    value: function renderItems() {
      ...
      return payload.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement("li", _extends$q({
          className,
          style: itemStyle,
          key: "legend-item-".concat(i)
        }, adaptEventsOfChild(_this.props, entry, i)), /* @__PURE__ */ o.createElement(Surface, {
          width: iconSize,
          height: iconSize,
          viewBox,
          style: svgStyle
        }, _this.renderIcon(entry)), /* @__PURE__ */ o.createElement("span", {
...
function renderContent$1(content, props) {
  if (/* @__PURE__ */ o.isValidElement(content)) {
    return /* @__PURE__ */ o.cloneElement(content, props);
  }
  if (typeof content === "function") {
    return /* @__PURE__ */ o.createElement(content, props);
  }
  props.ref;
  var otherProps = _objectWithoutProperties$e(props, _excluded$e);
  return /* @__PURE__ */ o.createElement(DefaultLegendContent, otherProps);
}
var EPS$1 = 1;
...
var constant$1 = constant_1, defineProperty$1 = _defineProperty$E, identity$8 = identity_1;
...
var DefaultTooltipContent = function DefaultTooltipContent2(props) {
    ...
    if (payload && payload.length) {
      ...
      var items = (itemSorter ? sortBy$1(payload, itemSorter) : payload).map(function(entry, i) {
        ...
        return (
          ...
          }, isNumOrStr(finalName) ? /* @__PURE__ */ o.createElement("span", {
            className: "recharts-tooltip-item-name"
          }, finalName) : null, isNumOrStr(finalName) ? /* @__PURE__ */ o.createElement("span", {
            className: "recharts-tooltip-item-separator"
          }, separator) : null, /* @__PURE__ */ o.createElement("span", {
            className: "recharts-tooltip-item-value"
          }, finalValue), /* @__PURE__ */ o.createElement("span", {
  ...
  return /* @__PURE__ */ o.createElement("div", _extends$p({
    className: wrapperCN,
    style: finalStyle
  }, accessibilityAttributes), /* @__PURE__ */ o.createElement("p", {
    className: labelCN,
    style: finalLabelStyle
  }, /* @__PURE__ */ o.isValidElement(finalLabel) ? finalLabel : "".concat(finalLabel)), renderContent2());
};
...
function renderContent(content, props) {
  ...
  return /* @__PURE__ */ o.createElement(DefaultTooltipContent, props);
}
var Tooltip = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$h(Tooltip2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ o.createElement(TooltipBoundingBox, {
        allowEscapeViewBox,
        animationDuration,
        animationEasing,
        isAnimationActive,
...
var ResponsiveContainer = /* @__PURE__ */ reactExports.forwardRef(function(_ref, ref) {
  ...
  var chartContent = reactExports.useMemo(function() {
    ...
    return o.Children.map(children, function(child) {
      if (/* @__PURE__ */ o.isValidElement(child)) {
...
var Text = function Text2(_ref5) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$o({}, filterProps(textProps, true), {
    x: x2,
    y: y2,
...
function _typeof$y(o2) {
  "@babel/helpers - typeof";
  return _typeof$y = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
...
function _getPrototypeOf$d(o2) {
  _getPrototypeOf$d = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf2(o22) {
...
function _setPrototypeOf$d(o2, p2) {
  _setPrototypeOf$d = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf2(o22, p22) {
    o22.__proto__ = p22;
    return o22;
  };
...
var renderRadialLabel = function renderRadialLabel2(labelProps, label, attrs) {
  ...
  return /* @__PURE__ */ o.createElement("text", _extends$m({}, attrs, {
...
function Label(_ref4) {
  ...
  return /* @__PURE__ */ o.createElement(Text, _extends$m({
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(Label, _extends$m({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ o.createElement(Layer, {
    ...
    return /* @__PURE__ */ o.createElement(Label, _extends$l({}, filterProps(entry, true), others, idProps, {
...
function parseLabelList(label, data) {
  ...
  if (label === true) {
    return /* @__PURE__ */ o.createElement(LabelList, {
      key: "labelList-implicit",
      data
    });
  }
  if (/* @__PURE__ */ o.isValidElement(label) || isFunction$3(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, {
      key: "labelList-implicit",
      data,
      content: label
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ o.createElement(LabelList, _extends$l({
      data
    }, label, {
      key: "labelList-implicit"
    }));
...
var Sector = function Sector2(sectorProps) {
  ...
  return /* @__PURE__ */ o.createElement("path", _extends$k({}, filterProps(props, true), {
    className: layerClass,
    d: path,
    role: "img"
  }));
...
function _typeof$p(o2) {
  "@babel/helpers - typeof";
  return _typeof$p = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o22) {
    return typeof o22;
  } : function(o22) {
    return o22 && "function" == typeof Symbol && o22.constructor === Symbol && o22 !== Symbol.prototype ? "symbol" : typeof o22;
  }, _typeof$p(o2);
...
var Animate = /* @__PURE__ */ function(_PureComponent) {
  ...
  _createClass$e(Animate2, [{
    ...
    value: function render() {
      ...
      return /* @__PURE__ */ o.createElement("div", null, reactExports.Children.map(children, function(child) {
...
var Rectangle = function Rectangle2(rectangleProps) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(props, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    }, /* @__PURE__ */ o.createElement("path", _extends$i({}, filterProps(props, true), {
      className: layerClass,
...
var Polygon = function Polygon2(props) {
  ...
  if (baseLinePoints && baseLinePoints.length) {
    ...
    return /* @__PURE__ */ o.createElement("g", {
      className: layerClass
    }, /* @__PURE__ */ o.createElement("path", _extends$h({}, filterProps(others, true), {
      fill: rangePath.slice(-1) === "Z" ? others.fill : "none",
      stroke: "none",
      d: rangePath
    })), hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$h({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(points, connectNulls)
    })) : null, hasStroke ? /* @__PURE__ */ o.createElement("path", _extends$h({}, filterProps(others, true), {
      fill: "none",
      d: getSinglePolygonPath(baseLinePoints, connectNulls)
    })) : null);
  }
  var singlePath = getSinglePolygonPath(points, connectNulls);
  return /* @__PURE__ */ o.createElement("path", _extends$h({}, filterProps(others, true), {
...
var Cross = function Cross2(_ref) {
  ...
  return /* @__PURE__ */ o.createElement("path", _extends$f({}, filterProps(props, true), {
...
var PolarRadiusAxis = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$d(PolarRadiusAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      return /* @__PURE__ */ o.createElement("line", _extends$e({
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$e({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$e({}, props, {
  ...
  return _createClass$c(PolarAngleAxis2, [{
    ...
    value: function renderAxisLine() {
      ...
      if (axisLineType === "circle") {
        return /* @__PURE__ */ o.createElement(Dot, _extends$d({
      ...
      return /* @__PURE__ */ o.createElement(Polygon, _extends$d({
        className: "recharts-polar-angle-axis-line"
      }, props, {
        points
      }));
    ...
    value: function renderTicks() {
      ...
      var items = ticks2.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$d({
          className: clsx("recharts-polar-angle-axis-tick", getTickClassName(tick)),
          key: "tick-".concat(entry.coordinate)
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && /* @__PURE__ */ o.createElement("line", _extends$d({
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        ...
        tickItem = /* @__PURE__ */ o.createElement(Text, _extends$d({}, props, {
...
var Trapezoid = function Trapezoid2(props) {
  ...
  if (!isUpdateAnimationActive) {
    return /* @__PURE__ */ o.createElement("g", null, /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
  ...
  return /* @__PURE__ */ o.createElement(Animate, {
    ...
    return /* @__PURE__ */ o.createElement(Animate, {
      ...
      duration: animationDuration,
      easing: animationEasing
    }, /* @__PURE__ */ o.createElement("path", _extends$c({}, filterProps(trapezoidProps, true), {
      className: layerClass,
...
function ShapeSelector(_ref) {
  ...
  switch (shapeType) {
    case "rectangle":
      return /* @__PURE__ */ o.createElement(Rectangle, elementProps);
    case "trapezoid":
      return /* @__PURE__ */ o.createElement(Trapezoid, elementProps);
    case "sector":
      return /* @__PURE__ */ o.createElement(Sector, elementProps);
    case "symbols":
      if (isSymbolsProps(shapeType)) {
        return /* @__PURE__ */ o.createElement(Symbols, elementProps);
      }
      break;
    default:
      return null;
...
function Shape(_ref2) {
  ...
  if (/* @__PURE__ */ reactExports.isValidElement(option)) {
    ...
    shape = /* @__PURE__ */ o.createElement(ShapeSelector, {
      shapeType,
  ...
  return _createClass$b(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$b({
        ...
        }), /* @__PURE__ */ o.createElement(Shape, _extends$b({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ o.createElement(Curve, _extends$b({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ o.createElement(Text, _extends$b({}, props, {
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$a(Brush2, [{
    ...
    value: function renderPanorama() {
      ...
      return /* @__PURE__ */ o.cloneElement(chartElement, {
        x: x2,
        y: y2,
        width,
        height,
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ o.createElement(Text, _extends$a({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ o.createElement(Text, _extends$a({
        textAnchor: "start",
        verticalAnchor: "middle",
    ...
    value: function render() {
      ...
      var isPanoramic = o.Children.count(children) === 1;
    ...
    value: function renderTraveller(option, props) {
      var rectangle;
      if (/* @__PURE__ */ o.isValidElement(option)) {
        rectangle = /* @__PURE__ */ o.cloneElement(option, props);
      } else if (isFunction$3(option)) {
...
var defineProperty = _defineProperty$E;
...
function BarRectangle(props) {
  return /* @__PURE__ */ o.createElement(Shape, _extends$9({
    shapeType: "rectangle",
  ...
  return _createClass$9(Bar2, [{
    ...
    value: function renderRectanglesStatically(data) {
      ...
      return data && data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(Layer, _extends$8({
          className: "recharts-bar-rectangle"
        }, adaptEventsOfChild(_this2.props, entry, i), {
          // https://github.com/recharts/recharts/issues/5415
          // eslint-disable-next-line react/no-array-index-key
          key: "rectangle-".concat(entry === null || entry === void 0 ? void 0 : entry.x, "-").concat(entry === null || entry === void 0 ? void 0 : entry.y, "-").concat(entry === null || entry === void 0 ? void 0 : entry.value, "-").concat(i)
        }), /* @__PURE__ */ o.createElement(BarRectangle, props));
      });
    }
  }, {
    ...
    value: function renderRectanglesWithAnimation() {
      ...
      return /* @__PURE__ */ o.createElement(Animate, {
        ...
        return /* @__PURE__ */ o.createElement(Layer, null, _this3.renderRectanglesStatically(stepData));
      });
    }
  }, {
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ o.createElement(BarRectangle, _extends$8({
    ...
    value: function render() {
      ...
      }))) : null, /* @__PURE__ */ o.createElement(Layer, {
...
var ChartLayoutContextProvider = function ChartLayoutContextProvider2(props) {
  ...
  return /* @__PURE__ */ o.createElement(XAxisContext.Provider, {
    value: xAxisMap
  }, /* @__PURE__ */ o.createElement(YAxisContext.Provider, {
    value: yAxisMap
  }, /* @__PURE__ */ o.createElement(OffsetContext.Provider, {
    value: offset
  }, /* @__PURE__ */ o.createElement(ViewBoxContext.Provider, {
    value: viewBox
  }, /* @__PURE__ */ o.createElement(ClipPathIdContext.Provider, {
    value: clipPathId
  }, /* @__PURE__ */ o.createElement(ChartHeightContext.Provider, {
    value: height
  }, /* @__PURE__ */ o.createElement(ChartWidthContext.Provider, {
    value: width
  }, children)))))));
};
...
var renderLine = function renderLine2(option, props) {
  var line;
  if (/* @__PURE__ */ o.isValidElement(option)) {
    line = /* @__PURE__ */ o.cloneElement(option, props);
  } else if (isFunction$3(option)) {
    line = option(props);
  } else {
    line = /* @__PURE__ */ o.createElement("line", _extends$7({}, props, {
...
var ReferenceLine = /* @__PURE__ */ function(_React$Component) {
  ...
  return _createClass$7(ReferenceLine2, [{
    key: "render",
    value: function render() {
      return /* @__PURE__ */ o.createElement(ReferenceLineImpl, this.props);
    }
  }]);
}(o.Component);
...
_defineProperty$9(ReferenceDot, "renderDot", function(option, props) {
  var dot;
  if (/* @__PURE__ */ o.isValidElement(option)) {
    dot = /* @__PURE__ */ o.cloneElement(option, props);
  } else if (isFunction$3(option)) {
    dot = option(props);
  } else {
    dot = /* @__PURE__ */ o.createElement(Dot, _extends$6({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty$8(ReferenceArea, "renderRect", function(option, props) {
  var rect;
  if (/* @__PURE__ */ o.isValidElement(option)) {
    rect = /* @__PURE__ */ o.cloneElement(option, props);
  } else if (isFunction$3(option)) {
    rect = option(props);
  } else {
    rect = /* @__PURE__ */ o.createElement(Rectangle, _extends$5({}, props, {
...
var CartesianAxis = /* @__PURE__ */ function(_Component) {
  ...
  return _createClass$4(CartesianAxis2, [{
    ...
    value: function renderTickItem(option, props, value) {
      ...
      if (/* @__PURE__ */ o.isValidElement(option)) {
        tickItem = /* @__PURE__ */ o.cloneElement(option, _objectSpread$3(_objectSpread$3({}, props), {}, {
...
var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
  ...
  var CategoricalChartWrapper = /* @__PURE__ */ function(_Component) {
    function CategoricalChartWrapper2(_props) {
      ...
      _defineProperty(_this, "renderCursor", function(element) {
        ...
        return /* @__PURE__ */ o.createElement(Cursor, {
          key,
          activeCoordinate,
          activePayload,
          activeTooltipIndex,
    ...
    return _createClass(CategoricalChartWrapper2, [{
      ...
      value: function render() {
        ...
        if (compact) {
          return /* @__PURE__ */ o.createElement(ChartLayoutContextProvider, {
            state: this.state,
            width: this.props.width,
            height: this.props.height,
            clipPathId: this.clipPathId
          }, /* @__PURE__ */ o.createElement(Surface, _extends({}, attrs, {
            width,
            height,
            title,
            desc
        ...
        return /* @__PURE__ */ o.createElement(ChartLayoutContextProvider, {
          ...
          height: this.props.height,
          clipPathId: this.clipPathId
        }, /* @__PURE__ */ o.createElement("div", _extends({
  ...
  _defineProperty(CategoricalChartWrapper, "renderActiveDot", function(option, props, key) {
    ...
    if (/* @__PURE__ */ reactExports.isValidElement(option)) {
      ...
      dot = /* @__PURE__ */ o.createElement(Dot, props);
    }
    return /* @__PURE__ */ o.createElement(Layer, {
  ...
  var CategoricalChart = /* @__PURE__ */ reactExports.forwardRef(function CategoricalChart2(props, ref) {
    return /* @__PURE__ */ o.createElement(CategoricalChartWrapper, _extends({}, props, {
      ref
    }));
  });
...
export {
  ...
  XAxis as X,
  YAxis as Y,
  adaptEventsOfChild as a,
  isEqual$1 as b,
  LabelList as c,
  isFunction$3 as d,
  findPositionOfBar as e,
  filterProps as f,
  getBaseValueOfBar as g,
  findAllByType as h,
  interpolateNumber$2 as i,
  getValueByDataKey as j,
  getCateCoordinateOfBar as k,
  getTooltipItem as l,
  mathSign as m,
  generateCategoricalChart as n,
  PolarRadiusAxis as o,
  polarToCartesian as p,
  formatAxisMap$1 as q,
  PieChart as r,
  Pie as s,
  truncateByDomain as t,
  Legend as u,
  CartesianGrid as v,
  Bar as w
};
